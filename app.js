...
/** @author Yash, Jemar and Vicki*/

/** Used to print out the given argument to the console
* @param {object} args - Any object
*/
...
/**
* @param {float} mass - Mass of the food being fired
* @example
* //return 8
* drawFireFood(9);
*/
...
/**
* @param {int} min - Minimum val in range
* 
*/
