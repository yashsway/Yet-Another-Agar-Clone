...
\subsection{The Scope of the Work}
    ...
    1. User Enters game & User ID (IN) User Position + Field state (OUT) & User chooses name and is placed in the live game. \\ \hline
...
b) Personalization and Internationalization Requirements \\
Not applicable to this project.
\medskip
...
d) Understandability and Politeness Requirements \\
Not applicable to this project.
\medskip
...
c) Precision of Accuracy Requirements \\
Not applicable to this project.
\medskip
...
e) Robustness or Fault Tolerance Requirements
\medskip
...
\fbox{
	\parbox{\textwidth}{
		...
		\textbf{Event/Use case \#:}  \\
		\textbf{Description:} The game must be runnable on the most recent versions of Safari, Chrome, and Internet Explorer. \\
...
b) Requirements for Interfacing with Adjacent Systems \\
Not applicable to this project.
\medskip
...
\fbox{
	\parbox{\textwidth}{
		...
		\textbf{Originator:} Vicky Bilbily \\
		\textbf{Fit Criterion:} Nobody but the administrator is able to access the server. \\
		\textbf{Customer Satisfaction:} 5 \ \ 
		\textbf{Customer Dissatisfaction:} 5 \\
		\textbf{Priority:} High \ \ 
		\textbf{Conflicts:} None \\
...
\fbox{
	\parbox{\textwidth}{
		...
		\textbf{Originator:} Vicky Bilbily \\
		\textbf{Fit Criterion:} The game does not break any rules of --name some internet standards act??-- \\
		\textbf{Customer Satisfaction:} 5 \ \ 
		\textbf{Customer Dissatisfaction:} 5 \\
		\textbf{Priority:} High \ \ 
		\textbf{Conflicts:} None \\
